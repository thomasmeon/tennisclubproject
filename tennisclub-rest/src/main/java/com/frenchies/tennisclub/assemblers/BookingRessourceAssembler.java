 ...
 */
@Component
public class BookingRessourceAssembler implements ResourceAssembler<BookingDTO, Resource<BookingDTO>> {
    ...
    public Resource<BookingDTO> toResource(BookingDTO bookingDTO) {
        ...
        try {
            ...
            Logger.getLogger(BookingRessourceAssembler.class.getName()).log(Level.SEVERE, "could not link resource from BookingsControllerHateoas", ex);
        }
