...
//		create2People();
//
//		Booking b1 = new Booking((long) 1, p1, p2, new Date(20171002), Hour24.EIGHT);
//
...
//
//		Booking b1 = new Booking((long) 1, p1, p2, new Date(20171002), Hour24.EIGHT);
//		Booking b2 = new Booking((long) 1, p1, p2, new Date(20171002), Hour24.NINE);
//
//		bookingDao.create(b1);
...
//		Booking b1 = new Booking((long) 1, p1, p2, new Date(20171002), Hour24.EIGHT);
//		Booking b2 = new Booking((long) 1, p1, p2, new Date(20171002), Hour24.NINE);
//		Booking b3 = new Booking((long) 1, p2, p1, new Date(20171002), Hour24.TEN);
//
//		bookingDao.create(b1);
//		bookingDao.create(b2);
